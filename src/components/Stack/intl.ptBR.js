...
const stack_ptBR = {
  ...
  [OTHER_SKILLS]: {
    ...
    [STACK[OTHER_SKILLS].AWS_LAMBDA_LAYER]: 'AWS Lambda Layer',
    ...
    [STACK[OTHER_SKILLS].OPENRESTY]: 'Openresty',
    ...
    [STACK[OTHER_SKILLS].ODOO]: 'Odoo',
    [STACK[OTHER_SKILLS].ANDROID]: 'Android SDK',
  },
  [BACKEND]: {
    title: 'knowledges( backend ) {',
    [STACK[BACKEND].TCL]: 'Tcl/Tk',
    [STACK[BACKEND].SERVERLESS]: 'Serverless',
    [STACK[BACKEND].RUST]: 'Rust',
    [STACK[BACKEND].NODE_JS]: 'NodeJS',
    [STACK[BACKEND].COBOL]: 'TinyCOBOL',
    ...
    [STACK[BACKEND].MSSQL]: 'Microsoft SQLServer',
    [STACK[BACKEND].MONGO_DB]: 'MongoDB',
    [STACK[BACKEND].REDIS]: 'Redis',
    [STACK[BACKEND].HIBERNATE]: 'Hibernate',
    [STACK[BACKEND].DJANGO]: 'Django',
